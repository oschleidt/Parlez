	<div id="optionform">
		...
		<div class="option" id="option_to_chat" onclick="document.location.href='/?page=chat'"> Zum Chat </div>
		<div class="option" id="option_invite_friends"> Freunde einladen</div>
		<div class="option" id="option_edit_profile" onclick="document.location.href='/?page=profilesettings'"> Profil bearbeiten</div>
